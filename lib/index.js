  ...
  compileTasks() {
    ...
    Object.keys(options.tasks).forEach((identifier) => {
      ...
      if (autoscaling != null) {
        ...
        template["Resources"][normalizedIdentifier + "AutoScalingRole"] =
          autoScalingRole;
        ...
        var autoScalingTarget = {
          ...
          Properties: {
            ...
            RoleARN: {
              "Fn::GetAtt": [normalizedIdentifier + "AutoScalingRole", "Arn"],
            },
          },
        };
        template["Resources"][normalizedIdentifier + "AutoScalingTarget"] =
          autoScalingTarget;
        ...
        var autoScalingPolicy = {
          ...
          Properties: {
            PolicyName:
              this.nameWithStage + "-" + name + "-auto-scaling-policy",
            PolicyType: "TargetTrackingScaling",
            ScalingTargetId: {
              Ref: normalizedIdentifier + "AutoScalingTarget",
            },
            TargetTrackingScalingPolicyConfiguration: {
              PredefinedMetricSpecification: {
                PredefinedMetricType:
                  autoscaling.metricType || "ECSServiceAverageCPUUtilization",
              },
        ...
        template["Resources"][normalizedIdentifier + "AutoScalingPolicy"] =
          autoScalingPolicy;
      }
    });
